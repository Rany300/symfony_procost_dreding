...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $employe1->setCost(23000);
        $employe1->setHiredAt(new \DateTimeImmutable('2020-01-01'));
        $employe1->setImageURL('/images/ui-sherman.jpg');
        ...
        $employe2->setCost(21000);
        $employe2->setHiredAt(new \DateTimeImmutable('2020-02-01'));
        $employe2->setImageURL('/images/ui-divya.jpg');
        ...
        $employe3->setCost(30000);
        $employe3->setHiredAt(new \DateTimeImmutable('2017-03-01'));
        $employe3->setImageURL('/images/user.jpg');
